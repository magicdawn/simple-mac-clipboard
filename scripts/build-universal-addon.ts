...
await $`mv ./build/Release/simple_mac_clipboard.node ./simple_mac_clipboard.darwin-x64.node`

await $`pnpm node-gyp rebuild --arch=arm64 --target_arch=arm64`
await $`mv ./build/Release/simple_mac_clipboard.node ./simple_mac_clipboard.darwin-arm64.node`
